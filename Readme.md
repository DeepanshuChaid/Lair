...
### 3. Rendering & Mutation Strategy

- **Direct DOM Manipulation**: Bypasses the React reconciliation loop during active drawing for **"butter-smooth"** 60 FPS mutations.
- **Undo/Redo Engine**: A robust history stack implementation allowing for seamless state traversal.
- **Write-Behind Persistence**: Debounced batching reduces database write operations by over **90%**, ensuring the app stays snappy even with multiple users.
